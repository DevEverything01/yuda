...
- **Fallback engine — offline:** sherpa-onnx (`sherpa-rs` bindings) + SenseVoice int8 model `sherpa-onnx-sense-voice-zh-en-ja-ko-yue-int8-2025-09-09`, with silero-vad endpointing, fully local CPU inference; model auto-downloads on first use with progress shown in the overlay.
